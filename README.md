...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytdc-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11234&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytdc-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytdc` can be installed with:

```
conda install pytdc
```

It is possible to list all of the versions of `pytdc` available on your platform with:
